		...
		<div class="writemain">
			...
			<article class="write2">
				<div class="write2_wrap">
					<ul class="write2_1">
						<li>Home > 고객문의</li>
						<li class="w2_1_1"><img src="../img/write/right1.gif"></li>
					</ul>
					...
					<form action="#">
						<table>
							<tr class="wt1">
								<td colspan="4">고객문의 입력</td>
							</tr>

							<tr>
								<td class="wt2">분류</td>
								<td class="wt3" colspan="3"><select>
							...
							<tr>
								...
								<td class="wt2file" colspan="3"><input type="file"> <br> ※ 업로드
									제한 사이즈 : 10MB※ 업로드 가능 확장자 : jpg, jpeg, png, gif</td>
							</tr>
							...
							<tr>
								<td colspan="4">
									<div class="wt2msg">
										· 본 고객문의는 메일을 통한 안내로 진행됩니다. <br> (필요한 경우 고객이 동의한 개인정보처리방침에 따라 홈페이지
										가입시에 등록한 연락처 또는 고객문의 본문에 고객이 직접 문의처리를 위해 기재한 개인정보를 활용하여 처리할 수
										있습니다.) <br> · 문의에 대한 답변은 고객정보 내 메일주소로 발송되며, 기재 오류 및 계정
										문제가 발생할 경우에는 답변이 불가할 수 있으므로 메일 주소를 꼭 확인해 주시기 바랍니다. <br> ·
										문의가 집중되거나 주말의 경우 답변이 지연될 수 있으니 신속한 답변이 필요하신 경우, 할리스커피
										대표번호(☎02-2188-7100)로 문의 주시기 바랍니다. <br> · 비속어 및 비방성 등의
										부적절한 내용이 포함되어 있는 경우, 답변 진행이 어려울 수 있습니다.
									</div>
